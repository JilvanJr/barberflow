                 ...
                 {totalPages > 0 && (
                    <div className="py-4 px-6 flex items-center justify-between border-t border-gray-200">
                        <span className="text-sm text-gray-600 font-medium">
                            Mostrando <span className="font-semibold">{(currentPage - 1) * itemsPerPage + 1}</span> a <span className="font-semibold">{Math.min(currentPage * itemsPerPage, processedServices.length)}</span> de <span className="font-semibold">{processedServices.length}</span> resultados
                        </span>
                        <div className="flex items-center space-x-2">
                            <button
